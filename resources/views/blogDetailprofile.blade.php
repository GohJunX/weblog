...
<body>
    <div class="container">
        ...
        @if(Auth::id()==$blog->u_id)
            <form action="{{ route('blog.delete', $blog->blog_id) }}" method="POST" class="delete-form" style="display: inline-block; margin-right: 10px;">
                @csrf
                @method('POST')
    ...
    <a href="javascript:history.back()" class="btn btn-back" style="display: inline-block;">Back</a>
</div>
